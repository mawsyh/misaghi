...
const Tag = ({ icon, title }: { icon: ReactNode; title: string }) => (
  <div className='hover:scale-105 duration-150 transition-all cursor-default flex items-center gap-2 mr-3 rounded-full py-2 px-5 w-max bg-neutral-50 dark:bg-neutral-800 dark:text-neutral-50 shadow-sm border border-neutral-300 dark:border-neutral-700'>
    {icon}
    <span>{title}</span>
  </div>
);
